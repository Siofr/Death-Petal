...
public class RebindActionUINew : MonoBehaviour
    ...
    {
        internal void Invoke(RebindActionUINew rebindActionUINew, string displayString, string deviceLayoutName, string controlPath)
        {
    ...
    {
        internal void Invoke(RebindActionUINew rebindActionUINew, InputActionRebindingExtensions.RebindingOperation operation)
        {
            throw new NotImplementedException();
        }
    }
